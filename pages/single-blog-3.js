          ...
          <div className='row'>
            <div className='col-lg-8 col-md-12'>
              <div className='blog-details-desc'>
                <div className='article-image-slides owl-theme'>
                  {display ? (
                    <OwlCarousel {...options}>
                ...
                <div className='article-content'>
                  ...
                  <h3>5 Ways to Convert Customers Into Advocates Brand</h3>
                  ...
                  <ul className='features-list'>
                    ...
                    <li>
                      <i className='bx bx-badge-check'></i> Communication skills to
                      getting in touch
                    </li>
                    <li>
                    ...
                    <li>
                      <i className='bx bx-badge-check'></i> A good work environment
                      for work
                    </li>
                  </ul>
