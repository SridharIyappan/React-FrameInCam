            ...
            <div className='col-lg-3 col-sm-6 col-md-6'>
              <div className='single-footer-widget'>
                ...
                <ul className='link-list'>
                  <li>
                    <a href='#'>
                      <i className='flaticon-left-chevron'></i> Project Cost Guides
                    </a>
                  </li>
                  <li>
                    <a href='#'>
            ...
            <div className='col-lg-3 col-sm-6 col-md-6'>
              <div className='single-footer-widget'>
                ...
                <ul className='link-list'>
                  <li>
                    <a href='#'>
                      <i className='flaticon-left-chevron'></i> Claim your Business
                    </a>
                  </li>
                  <li>
                    <a href='#'>
                      <i className='flaticon-left-chevron'></i> Advertise on Indice
                    </a>
                  </li>
                  <li>
                    <a href='#'>
